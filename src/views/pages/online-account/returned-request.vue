...
//   components: { createLearningSublist },
  ...
  methods: {
    ...
    getNewRequest(type = 'default') {
      let params;
      if (type == 'default') {
        params = this.getRequestParams(this.currentPage, this.perPage, 'Returned')
      } else {
        params = this.getRequestParams(1, 10, 'Returned', this.searchParams.email, this.searchParams.mobile_no, this.searchParams.ref_no);
      }
