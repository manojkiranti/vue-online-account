                ...
                <div class="col-sm-12 col-md-6">
                  <div class="d-flex justify-content-end align-items-center">
                    <div id="tickets-table_filter" class="dataTables_filter text-md-right">
                      ...
                      <button class="btn btn-primary btn-sm" @click="getSearchResults">
                        <b-spinner small v-if="isTableDataLoading"></b-spinner> Search
                      </button>
                    </div>
                ...
                <div class="table-responsive mb-0">
                  <b-table :items="tableData" :fields="fields" responsive="sm" :current-page="currentPage"
                    ...
                    <template v-slot:cell(action)="row">
                      ...
                      <a href="javascript:void(0);" class="text-danger mr-3" v-b-tooltip.hover @click="printItem(row)"
                        title="Print">
...
export default {
  ...
  methods: {
    ...
    printItem(row) {
      window.open(`https://dev.globalordernow.com/online-account-pdf-view/${row.item.guid}`, '_blank').focus();
    },
    openCreateModal() {
    ...
    getNewRequest(type = 'default') {
      let params;
      if (type == 'default') {
        params = this.getRequestParams(this.currentPage, this.perPage, 'Approved')
      } else {
        params = this.getRequestParams(1, 10, 'Approved', this.searchParams.email, this.searchParams.mobile_no, this.searchParams.ref_no);
      }
