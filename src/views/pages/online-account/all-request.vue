                    ...
                    >
                      <label class="d-inline-flex align-items-center mb-0 mr-2">
                        ...
                        <b-form-input
                          ...
                          placeholder="Mobile"
                          class="form-control form-control-sm ml-2"
                          v-model="searchParams.mobile_no"
                        ></b-form-input>
                        <b-form-input
                          type="search"
                          placeholder="ref no"
                          class="form-control form-control-sm ml-2"
                          v-model="searchParams.ref_no"
                        ></b-form-input>
                      </label>
                ...
                <div class="table-responsive mb-0">
                  ...
                  >
                    ...
                    <template v-slot:cell(acc_status)="row">
                      {{ row.item.acc_status.account_status}}
                    </template>
...
export default {
  ...
  methods: {
    editItem(row) {
      ...
      console.log("row", row);
      this.$router.push(
        `/online/all-request/review-account/${this.selectedRow.guid}`
      );
    },
    deleteItem(row) {
      this.$bvModal
    ...
    getRequestParams(page, pageSize, email, mobile_no, ref_no) {
      let params = {};
    ...
    getNewRequest(type = 'default') {
      let params;
      if (type == 'default') {
        params = this.getRequestParams(this.currentPage, this.perPage)
      } else{
        params = this.getRequestParams(1, 10, this.searchParams.email,  this.searchParams.mobile_no,this.searchParams.ref_no );
      }
