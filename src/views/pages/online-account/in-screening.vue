...
export default {
  ...
  methods: {
    ...
    getNewRequest(type = 'default') {
      let params;
      if (type == 'default') {
        params = this.getRequestParams(this.currentPage, this.perPage, 'InScreening')
      } else {
        params = this.getRequestParams(1, 10, 'InScreening', this.searchParams.email, this.searchParams.mobile_no, this.searchParams.ref_no);
      }
