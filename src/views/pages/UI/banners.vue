                ...
                <div class="table-responsive mb-0">
                  ...
                  >
                    ...
                    <template v-slot:cell(thumb_image)="row">
                       <img :src="+row.item.thumb_image" alt="" />
                    </template>
...
import BannerUpdateModal from "./BannerUpdateModal.vue";
...
export default {
  ...
  name: "UiBanners",
  mixins: [Promise],
  components: { Layout, PageHeader, BannerUpdateModal },
  data() {
    return {
      title: "Home Banner",
      items: [
    ...
    createProductCategory(payload) {
      ...
      if(this.modalType == 'create') {
        ...
        operation = this.response(
            Api.createProductCategory(formData)
        );
      } else{
