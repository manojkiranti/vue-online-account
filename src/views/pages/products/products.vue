          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mt-4">
                ...
                >
                  <product-modal
                    @submitForm="createProductCategory"
...
export default {
  ...
  methods: {
    editItem(row) {
      ...
      console.log("row", row);
      this.formModalTitle = "Update Product";
    ...
    openCreateModal() {
      this.formModalTitle = "Create Product";
    ...
    getNewRequest() {
      ...
      this.isTableDataLoading = true;
      const operation = this.response(Api.getProducts(params));
      operation
        .then((data) => {
          if (operation.isFulfilled()) {
    ...
    getProductCategoryList () {
      ...
      const operation = this.response(Api.getProductCategory());
      operation
        .then((data) => {
          if (operation.isFulfilled()) {
    ...
    createProductCategory(payload) {
      ...
      if(this.modalType == 'create') {
        ...
        operation = this.response(
            Api.updateProduct(this.selectedRow.id ,formData)
        );
      }
